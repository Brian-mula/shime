<template>
  <div>
    ...
    <!-- !buy a coffee link -->
    <div
      class="flex items-end justify-between fixed bottom-0 right-0 mb-4 mr-4 z-10"
    >
      <div>
        <a
          title="Buy me a beer"
          href="https://www.buymeacoffee.com/mulatiwangA"
          target="_blank"
          class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12"
        >
          <img
            class="object-cover object-center w-full h-full rounded-full"
            src="https://cdn.pixabay.com/photo/2015/05/07/13/46/cappuccino-756490__340.jpg"
          />
        </a>
      </div>
      ...
      <div>
        <div>
          <a
            title="Buy me a beer"
            href="https://www.buymeacoffee.com/andrewomosr"
            target="_blank"
            class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12"
          >
            <img
  ...
  setup() {
    ...
    const handleLogin=async()=>{
      if(password.value && password.value>=6 && email.value){
        ...
        passwordError.value='fill out password '
      }
      
    }
    return {
      email,password,emailError,passwordError,handleLogin
    };
  },
};
</script>
